...
<head>
    ...
    <title>Sapphire Radeon RX 6950 XT NITRO+ 16GB GDDR6 256-bit</title>
...
<body>
    ...
    <div class="container">
        <div class="img-display">
            <div class="images">
                <img src="./img/Sapphire-RadeonRX6950/im1.jpg" alt="" class="img">
                <img src="./img/Sapphire-RadeonRX6950/im2.jpg" alt="" class="img">
                <img src="./img/Sapphire-RadeonRX6950/im3.jpg" alt="" class="img">
            </div>
            <h2>Pret: 10000 RON</h2>
            <div class="add-to-cart">
                <div class="add-to-cart-container">
                    <div class="set-quantity">
                        <button class="minus">-</button>
                        <input type="text" disabled value="1" class="quantity" id="qnty1">
            ...
            <table>
                <tr>
                    <td>Denumire:</td>
                    <td>Placa video Sapphire Radeon RX 6950 XT NITRO+ 16GB GDDR6 256-bit</td>
                </tr>
                <tr>
                    <td>Garantie:</td>
                    <td>24 luni</td>
    ...
    <script type="module" src="./scripts/pv1.js"></script>
</body>
</html>