...
<head>
    ...
    <title>Ryzen Threadripper 3960X</title>
...
<body>
    ...
    <div class="container">
        <div class="img-display">
            <div class="images">
                <img src="./img/RyzenThreadripper-3960X/im1.jpg" alt="" class="img">
                <img src="./img/RyzenThreadripper-3960X/im2.jpg" alt="" class="img">
                <img src="./img/RyzenThreadripper-3960X/im3.jpg" alt="" class="img">
            </div>
            <h2>Pret: 8000 RON</h2>
            <div class="add-to-cart">
                <div class="add-to-cart-container">
                    <div class="set-quantity">
                        ...
                        <input type="text" disabled value="1" class="quantity" id="qt6">
            ...
            <table>
                <tr>
                    <td>Denumire:</td>
                    <td>Procesor AMD Ryzen Threadripper 3960X 3.8GHz</td>
                </tr>
                <tr>
                    <td>Garantie:</td>
                    <td>24 luni</td>
    ...
    <script type="module" src="./scripts/procesor6.js"></script>
</body>
</html>