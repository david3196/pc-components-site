...
<head>
    ...
    <title>Ryzen Threadripper 2970WX</title>
...
<body>
    ...
    <div class="container">
        <div class="img-display">
            <div class="images">
                <img src="./img/RyzenThreadripper-2970WX/im1.jpg" alt="" class="img">
                <img src="./img/RyzenThreadripper-2970WX/im2.jpg" alt="" class="img">
                <img src="./img/RyzenThreadripper-2970WX/im3.jpg" alt="" class="img">
            </div>
            <h2>Pret: 7500 RON</h2>
            <div class="add-to-cart">
                <div class="add-to-cart-container">
                    <div class="set-quantity">
                        ...
                        <input type="text" disabled value="1" class="quantity" id="qt7">
            ...
            <table>
                <tr>
                    <td>Denumire:</td>
                    <td>Procesor AMD Ryzen Threadripper 2970WX 3.0GHz</td>
                </tr>
                <tr>
                    <td>Garantie:</td>
                    <td>24 luni</td>
    ...
    <script type="module" src="./scripts/procesor7.js"></script>
</body>
</html>