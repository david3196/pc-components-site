...
<head>
    ...
    <title>Ryzen Threadripper PRO 3955WX</title>
...
<body>
    ...
    <div class="container">
        <div class="img-display">
            <div class="images">
                <img src="./img/RyzenThreadripperPRO-3955WX/im1.jpg" alt="" class="img">
                <img src="./img/RyzenThreadripperPRO-3955WX/im2.jpg" alt="" class="img">
                <img src="./img/RyzenThreadripperPRO-3955WX/im3.jpg" alt="" class="img">
            </div>
            <h2>Pret: 6500 RON</h2>
            <div class="add-to-cart">
                <div class="add-to-cart-container">
                    <div class="set-quantity">
                        ...
                        <input type="text" disabled value="1" class="quantity" id="qt8">
            ...
            <table>
                <tr>
                    <td>Denumire:</td>
                    <td>Procesor AMD Ryzen Threadripper PRO 3955WX 3.9GHz</td>
                </tr>
                <tr>
                    <td>Garantie:</td>
                    <td>24 luni</td>
    ...
    <script type="module" src="./scripts/procesor8.js"></script>
</body>
</html>