...
<body>
    ...
    <div class="container">
        <div class="img-display">
            <div class="images">
                <img src="./img/Ryzen9-3950X/im1.jpg" alt="" class="img">
                <img src="./img/Ryzen9-3950X/im2.jpg" alt="" class="img">
                <img src="./img/Ryzen9-3950X/im3.jpg" alt="" class="img">
            </div>
            <h2>Pret: 4500 RON</h2>
            <div class="add-to-cart">
                <div class="add-to-cart-container">
                    <div class="set-quantity">
                        ...
                        <input type="text" disabled value="1" class="quantity" id="qt2">
            ...
            <table>
                <tr>
                    <td>Denumire:</td>
                    <td>Procesor AMD Ryzen 9 3950X 3.5GHz</td>
                </tr>
                <tr>
                    <td>Garantie:</td>
                    <td>24 luni</td>
    ...
    <script type="module" src="./scripts/procesor2.js"></script>
</body>
</html>