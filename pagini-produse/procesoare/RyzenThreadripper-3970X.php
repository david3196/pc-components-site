...
<head>
    ...
    <title>Ryzen Threadripper 3970X</title>
...
<body>
    ...
    <div class="container">
        <div class="img-display">
            <div class="images">
                <img src="./img/RyzenThreadripper-3970X/im1.jpg" alt="" class="img">
                <img src="./img/RyzenThreadripper-3970X/im2.jpg" alt="" class="img">
                <img src="./img/RyzenThreadripper-3970X/im3.jpg" alt="" class="img">
            </div>
            <h2>Pret: 12000 RON</h2>
            <div class="add-to-cart">
                <div class="add-to-cart-container">
                    <div class="set-quantity">
                        <button class="minus">-</button>
                        <input type="text" disabled value="1" class="quantity" id="qt5">
            ...
            <table>
                <tr>
                    <td>Denumire:</td>
                    <td>Procesor AMD Ryzen Threadripper 3970X 3.7GHz</td>
                </tr>
                <tr>
                    <td>Garantie:</td>
                    <td>24 luni</td>
    ...
    <script type="module" src="./scripts/procesor5.js"></script>
</body>
</html>