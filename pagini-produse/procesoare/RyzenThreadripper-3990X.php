...
<head>
    ...
    <title>Ryzen Threadripper 3990X</title>
...
<body>
    ...
    <div class="container">
        <div class="img-display">
            <div class="images">
                <img src="./img/RyzenThreadripper-3990X/im1.jpg" alt="" class="img">
                <img src="./img/RyzenThreadripper-3990X/im2.jpg" alt="" class="img">
                <img src="./img/RyzenThreadripper-3990X/im3.jpg" alt="" class="img">
            </div>
            <h2>Pret: 20000 RON</h2>
            <div class="add-to-cart">
                <div class="add-to-cart-container">
                    <div class="set-quantity">
                        <button class="minus">-</button>
                        <input type="text" disabled value="1" class="quantity" id="qt4">
            ...
            <table>
                <tr>
                    <td>Denumire:</td>
                    <td>Procesor AMD Ryzen Threadripper 3990X 2.9GHz</td>
                </tr>
                <tr>
                    <td>Garantie:</td>
                    <td>24 luni</td>
    ...
    <script type="module" src="./scripts/procesor4.js"></script>
</body>
</html>